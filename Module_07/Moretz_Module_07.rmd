...
Let $\rho_P \le w_1\sigma_1 + w_2\sigma_2$

\setlength{\leftskip}{0pt}

When $\alpha < 0.5$, then $Z_\alpha < 0$, so that:
...
var1d <- VaR_norm(0.1, port.ret, sqrt(port.var), S = capital)
...
var5d <- VaR_norm(0.1, port.ret, sqrt(port.var), S = capital)
