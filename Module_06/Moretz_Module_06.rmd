...
z_score <- as.numeric( ( ret.blm - ret.pred) / ret.sd )
...
The residual diagnostics for the AR(1) + ARCH(1) are almost identical to the AR(1) + ARCH(1).
...
```{r, AR_CGAUSS_model, fig.height=4, echo = T}
